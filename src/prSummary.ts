...
function renderPrSummaryMarkdown(
  ...
  return [
    ...
    "",
    "## Summary",
    "Prepare the initial TheSkeleton implementation artifacts for review before any push or PR creation.",
    "",
    "## Changes included",
    "- Initial target repository orchestration and planning artifacts",
    "- Placeholder Google auth boundary in the project plan",
    ...
    "- Target repository build should be run locally after cloning",
    "- Browser review should be done with `npm run dev` in the cloned target repo",
    "",
    "## Known limitations",
